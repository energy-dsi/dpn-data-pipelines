...
"""
Airflow DAG: consumer_file

Orchestrates the already-running Kubernetes pods for consumer-file via Kafka.
...
with DAG(dag_id="consumer_file",default_args=_DEFAULT,
         description="consumer-file — Kafka trigger, existing pods, no new K8s pods",
         schedule_interval=SCHEDULE,start_date=days_ago(1),
         catchup=False,max_active_runs=1,
         tags=["dpn","consumer","file","consumer-file","kafka-trigger"]) as dag:
