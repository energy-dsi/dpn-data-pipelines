...
SOURCE_PATH = Path(
    os.getenv(
        ...
        "blueprints/producer/topic/eq/schema_mapper/main.py",
    )
)
...
def test_main_block_creates_backend_heartbeat_and_executes_run():
    ...
    assert kwargs == {
        ...
        "component_name": "producer-topic-schema-mapper-eq",
    }
    ...
    assert heartbeat.component_name == "producer-topic-schema-mapper-eq"
