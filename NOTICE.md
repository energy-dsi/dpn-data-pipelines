...
Attributions, licence texts, and notices for these third-party components are provided within the repository (including, where applicable, in accompanying  [THIRD-PARTY-LICENSES](./THIRD_PARTY_LICENSE.md) files) and should be reviewed prior to use, modification, or distribution of the software.
