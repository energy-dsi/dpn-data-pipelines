...
def main():
    eqbd_schema_validate = EQBDSchemaMapper()
    data = eqbd_schema_validate.read_records()
    eqbd_schema_validate.write_records(data=data)
    # eqbd_schema_validate.send_to_kafka()
